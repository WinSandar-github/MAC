...
use App\CpaTwoRegPrivateTrainNewbie;


class CpaTwoPrivateNewbieController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $cpa_two_tra_reg = new CpaTwoRegPrivateTrainNewbie();
        $cpa_two_tra_reg->private_training_name = $request->pri_tra_name;
