...
class StudentRegisterController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->remain_module == 1 || $request->remain_module == 2 
            || $request->remain_module==0  && $request->remain_module != null || $request->remain_module == "fail") {
        ...
        switch ($request->type) {
            case 0:
                ...
                $invoice->invoiceNo       = 'self_reg_' . $std->batch->course->code . '_' . $student_register->id;
            ...
            case 1:
                ...
                $invoice->invoiceNo = 'prv_reg_' . $std->batch->course->code . '_' . $student_register->id;
            ...
            case 2:
                ...
                $invoice->invoiceNo = 'mac_reg_' . $std->batch->course->code . '_' . $student_register->id;
    ...
    public function FilterRegistration(Request $request)
    {
        ...
        $datatable = DataTables::of($student_register)
            ...
            ->addColumn('payment_status', function ($student){
                ...
                $invoices = Invoice::where('invoiceNo',$reg_type.$course_code.$student->id)->get();
