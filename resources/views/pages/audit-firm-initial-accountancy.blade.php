                                                        ...
                                                        <table class="table branch table-bordered input-table">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th >
                                                                        ...
                                                                        <button class="btn btn-primary btn-xs" type="button" onclick='addRowBranch("branch")'>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button class="btn btn-primary btn-xs" type="button" onclick='addInputTele("branch")'>
                                                                            <i class="fa fa-plus"></i>
                                                                        </button>
                                                    ...
                                                    <div class="col-md-10">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label class="col-form-label">(a)Copy of valid Public Practice Accountant Certificate</label>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label class="col-md-12 col-form-label">(b)Copy of stationery/ letterhead to be used in signing of auditor's report</label>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label class="col-md-12 col-form-label">(c)Copy of Tax clearance from Internal Revenue Department</label>
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label class="col-md-12 col-form-label">(d)Representative Letter and Copy of representative's NRC Card if Not Self-Registration</label>
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="less-font-weight" rowspan="2" style="text-align: right;">
                                                                            ...
                                                                            <button class="btn btn-primary btn-xs" type="button" onclick='addRowPartner("partner_list")'>
                                                                                <i class="fa fa-plus"></i>
                                                                            </button>
                                                                        </th>
                                                                    </tr>
                                                                ...
                                                                <thead>
                                                                    <tr>
                                                                        ...
                                                                        <th class="less-font-weight" style="text-align: right;">
                                                                            ...
                                                                            <button class="btn btn-primary btn-xs" type="button" onclick='addRowDirector("director")'>
                                                                                <i class="fa fa-plus"></i>
                                                                            </button>
                                                                        </th>
                                                                    </tr>
