                    ...
                    <form action="" method="post">
                        <div class="card ">
                            <div class="card-header ">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h5 class="title" style="padding-left: 330px;">{{ __('Non-Audit Firm Registration List') }}</h5>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                <div class="tab-space tab-content tab-no-active-fill-tab-content">
                                                    ...
                                                    <div class="tab-pane fade" id="link2" aria-expanded="true">
                                                        <table id="tbl_non_audit_approved" class="table table-hover text-nowrap">
                                                            <thead>
                                                                <tr>
                                                                    <th class="bold-font-weight">Sr</th>
                                                                    <th class="bold-font-weight">Action</th>
                                                    ...
                                                    <div class="tab-pane fade" id="link3" aria-expanded="true">
                                                        <table id="tbl_non_audit_rejected" class="table table-hover text-nowrap">
                                                            <thead>
                                                                <tr>
                                                                    <th class="bold-font-weight">Sr</th>
                                                                    <th class="bold-font-weight">Action</th>
