        ...
        <form id="audit_firm_form" method="post" action="javascript:updateAuditFirm();" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <div class="card custom-border-top card-stats">
                        ...
                        <div class="card-body">
                            <h5 class="border-bottom pb-2 mt-3 text-center" style="font-weight:bold">Audit Firm Reconnect Information</h5>
                              <div class="row">
                              ...
                              <div class="row pl-4 mt-2 border-bottom">
                                ...
                                <div id="reconnect_btns">
	                                    ...
	                                    <button type="submit" name="save" id="approve_audit_btn_reconnect" class="btn btn-primary" onclick="approveAuditFirmReconnect()" style="width : 20%"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>APPROVE</button>
	                                </div>
																</div>
    ...
    <div class="modal fade" id="remarkModalReconnect" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      			  <div class="modal-dialog modal-dialog-centered" style="max-width: 600px !important">
      			    <div class="modal-content">
      			      ...
      			      <form id="remark-form-reconnect"  method="post" action="javascript:rejectAuditFirmReconnect()" enctype="multipart/form-data">
      			      @csrf
      			        <div class="modal-body">
      			            <div class="row">
      			                <div class="col-md-12">
