                            ...
                            <div class="card-body">
                            	...
                            	<div class="tab-space tab-content tab-no-active-fill-tab-content mt-4">
	                                    ...
	                                    <div class="row">
	                                      ...
	                                      <div class="col-md-8">
	                                          <div class="form-group">
	                                              <input type="text" name="accountancy_firm_register_no" class="form-control" placeholder="Accountancy Firm Registration No" oninput="this.value=this.value.replace(/[^က-အ၀-၉]/g,'')">
	                                          </div>
	                                      </div>
	                                    </div>
	                                  <div class="row">
                                                        ...
                                                        <table id="myTable" class="table profile table-bordered">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" value="" name="cpa_no[]" class="form-control"></td>
                                  ...
                                  <div class="tab-pane fade" id="link2" aria-expanded="true">
	                                <div class="row">
	                                      <label class="col-md-1 col-form-label">{{ __('1။') }}</label>
	                                      <label class="col-md-2 col-form-label">{{ __('Name Of Sole Proprietor/Managing Partner') }}</label>
	                                      <div class="col-md-8">
	                                          <div class="form-group">
	                                              <input type="text" name="name_sole_manager" id="name_sole_manager" class="form-control" placeholder="Name Of Sole Proprietor/Managing Partner" oninput="this.value=this.value.replace(/[^က-အ၀-၉]/g,'')">
	                                          </div>
	                                      </div>
	                                </div>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="row">
	                                      <label class="col-md-1 col-form-label">{{ __('4။') }}</label>
	                                      <label class="col-md-2 col-form-label">{{ __('Types Of Service Provided') }}</label>
	                                      <div class="col-md-3">
	                                          <div class="">
