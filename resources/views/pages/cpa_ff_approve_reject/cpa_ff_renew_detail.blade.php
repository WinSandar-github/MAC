                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="row mt-5 justify-content-center" id="cpaff_approve_reject">
                                    ...
                                    <button type="submit" name="save" class="btn btn-primary" onclick="approveRenewCPAFFUser()" style="width : 20%"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>APPROVE</button>
                                </div>                               
                            </div>
                        </div>
...
<div class="modal fade" id="payment_detail_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"> CPA(Full-Fledged) Renewal Registration Fees</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
<script>
    ...
    $.ajax({
        url: BACKEND_URL + "/get_payment_info/" + 'cpaff_renew'+cpa_ff_id,
        type: 'get',
