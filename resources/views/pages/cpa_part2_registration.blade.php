                                  ...
                                  <div class="tab-pane fade show active" id="link1" aria-expanded="true">
	                                  ...
	                                  <div class="row">
	                                    ...
	                                    <div class="row">
	                                      ...
	                                      <label class="col-md-2 col-form-label">{{ __('လက်မှတ်ရပြည်သူ့စာရင်းကိုင်(ပထမ)ပိုင်းစာမေးပွဲအောင်မြင်သည့်နှစ်/လ') }}</label>
	                                        <div class="col-md-8">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
	                                      <label class="col-md-1 col-form-label"></label>
	                                      <label class="col-md-2 col-form-label">{{ __('ကိုယ်ပိုင်အမှတ်နှင့်အဆင့်') }}</label>
	                                        <div class="col-md-8">
                                                <div class="form-group">
                                                            <input type="text" name="" class="form-control" >
                                                </div>
                    ...
                    <button type="submit" class="btn btn-info btn-round">{{ __('Save') }}</button>
                                  ...
                                  <div class="tab-pane fade" id="link2" aria-expanded="true">
	                                  ...
	                                  <div class="row">
                                        ...
                                        <div class="row">
                                            <label class="col-md-1 col-form-label"></label>
                                            <label class="col-md-10 col-form-label">{{ __('မှတ်ချက်။	သင်တန်းတက်ခွင့်နှင့်မှတ်ပုံတင်ခွင့်(လျှောက်လွှာကြေး ၁၀၀၀ကျပ်၊မှတ်ပုံတင်ကြေး ၁၀၀၀၀ကျပ်)') }}</label>
