...
@section('content')
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-12">
            {{ Breadcrumbs::render('cpa_two_privateschool_edit') }}
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-4 ">
                                ...
                                <div class="row m-2 mt-3 border-bottom">
                                    <div class="col-md-6">
                                        <p class="ml-2" style="font-weight:bold">CPA One Success Date</p>
                                    </div>
                                    <div class="col-md-6">
                                        <span id="cpa_one_pass_date"></span>
                                    </div>
                                </div>
                                <div class="row m-2 mt-3 border-bottom">
                                    <div class="col-md-6">
                                        <p class="ml-2" style="font-weight:bold">CPA One Access No</p>
                                    </div>
                                    <div class="col-md-6">
                                        <span id="cpa_one_access_no"></span>
                                    </div>
                                </div>
                                <div class="row m-2 mt-3 border-bottom">
                                    <div class="col-md-6">
                                        <p class="ml-2" style="font-weight:bold">CPA One Success No</p>
                                    </div>
                                    <div class="col-md-6">
                                        <span id="cpa_one_success_no"></span>
                                    </div>
                                </div>
                                <div class="row m-2 mt-3 border-bottom">
                                    <div class="col-md-6">
...
@push('scripts')
<script>
    loadCPATwoPrivateSchoolStudentData();
