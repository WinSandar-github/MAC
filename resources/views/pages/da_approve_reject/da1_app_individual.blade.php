                ...
                <div class="card px-5">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-5 justify-content-center" id="approve_reject">
                            <button type="submit" name="save" id="reject" class="btn btn-danger" data-toggle="modal"
                                    data-target="#exampleModal" style="width : 20%"><i class="fa fa-thumbs-o-down"
                                                                                       aria-hidden="true"></i>Reject
                                Student
                            </button>
                            <button type="submit" name="save" id="approve" class="btn btn-primary"
                                    onclick="approveUser({{ $student->student_info_id }})" style="width : 20%"><i class="fa fa-thumbs-o-up"
        ...
        $(document).ready(function () {
            ...
            if ({{ $student->type }} == 2) {
                ...
                $('input[type=radio][name=mac_type]').map((key, val) => {
                    return $(val).val() == {{ $student->mac_type }} ? $(val).attr('checked', 'true') : '';
                });
            } else {
                $('#blk_mac').hide();
            }
