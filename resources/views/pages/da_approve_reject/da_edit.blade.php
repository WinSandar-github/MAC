                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <center>
                                        <img id="image" width="30%" class="rounded-circle"
                                    ...
                                    <div class="da_two_pass_info" style="display:none">
                                        <h5 class="border-bottom pb-2 mt-3" style="font-weight:bold">Informations of
                                            Passed the DA Part-Two Exam</h5>
                                        <div class="row m-2 mt-3 border-bottom">
                                            <div class="col-md-6 text-left">
                                                <p class="ml-2" style="font-weight:bold">Certificate of Passed the DA
                                                    Part-Two Exam</p>
                                            </div>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <div class="row m-2 mt-3 border-bottom">
                                        <div class="col-md-6 text-left">
                                            <p class="ml-2 text-bold" style="font-weight:bold">Name(Eng) /
                                                Name(Myanmar)</p>
                                        </div>
                                        <div class="col-md-6 text-left">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 text-left">
                                            <img class="nrc-style" id="nrc_front_img" accept="image/png,image/jpeg"
                                                 alt="">
                                        </div>
                                        <div class="col-md-6 text-left">
                                            <img class="nrc-style" id="nrc_back_img" accept="image/png,image/jpeg"
                                                 alt="">
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="row mt-5 justify-content-center" id="approve_reject">
                                    <button type="submit" name="save" id="reject" class="btn btn-danger"
                                            data-toggle="modal" data-target="#exampleModal" style="width : 20%"><i
                                            class="fa fa-thumbs-o-down" aria-hidden="true"></i>REJECT
                                    </button>

                                    <button type="submit" name="save" id="approve" class="btn btn-primary"
                                            onclick="approveUser()" style="width : 20%"><i class="fa fa-thumbs-o-up"
