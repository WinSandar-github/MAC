...
@extends('layouts.app', [
    'class' => '',
    'elementActive' => 'da_part2_register_form3'
])
...
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                {{ Breadcrumbs::render('da_part2_register_form3') }}
            </div>
        </div>
                                ...
                                <div class="row">
	                                  ...
	                                  <div class="row">
	                                    ...
	                                    <div class="row">
	                                      ...
	                                      <div class="col-md-8">
                                            <div class="form-group">
                                                        <input type="text" name="birth3" class="form-control" placeholder="dd-mm-yyyy">
                                                    </div>
                                                </div>
	                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <input type="text" name="date4" class="form-control" placeholder="dd-mm-yyyy">
                                                </div>
                                            </div>
