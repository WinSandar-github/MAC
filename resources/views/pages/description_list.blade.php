...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            <button type="button" id="create_btn" class="btn btn-primary btn-round" data-toggle="modal"
                                data-target="#create_description_model">Create</button>
                        </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="create_description_model" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <form id="description_form" method="post" action="javascript:createDescription();"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <textarea name="description_name" class="form-control" id="des_name"
                                        placeholder="Name" autocomplete="off"></textarea>
                                </div>
                            </div>
                        </div>
