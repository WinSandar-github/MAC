...
@section('content')
                ...
                <form   action="{{ url('') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <h5 class="card-title">{{ __('Exam List') }}</h5>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 d-md-flex justify-content-md-end">
                                    <button type="button" class="btn btn-primary btn-round" id="create_btn" data-toggle="modal" data-target="#create_exam_modal">Create</button>
                                </div>
                            </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="create_exam_modal" style="padding-top:150px;" >
            ...
            <form id="exam_form" method="post" action="javascript:createExam();" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">                                
                                <select class="form-control form-select" name="exam_type_id" id="selected_examtype_id" style="width: 100%;"
                                 onchange="loadeCourse()"
                                 required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">                                
                                <select class="form-control form-select" name="course_id" id="selected_ecourse_id" style="width: 100%;"
                                 onchange="loadeBatch()"
                                 required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">                                
                                <select class="form-control form-select" name="batch_id" id="selected_ebatch_id" style="width: 100%;" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">                                
                                <input type="text" name="exam_start_date" class="form-control"  placeholder="DD-MMM-YYYY">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">                                
                                <input type="text" name="exam_end_time" class="form-control" autocomplete="off" placeholder="H:m" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">                                
                                <input type="text" name="exam_place" class="form-control" autocomplete="off" placeholder="Enter the exam palce" required>
                            </div>
                        </div>
                    </div>
