                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-md-12 text-right">
                            <button class="btn btn-primary btn-round m-0" onclick="window.location.href='cpa1_exam_result_edit'">Go to Exam Result List</button>
                        </div>
                        {{--<div class="row">
                            <div class="col-md-5">
                                <div class="row">
                    ...
                    <div class="card-body">
                        <div class="tab-space tab-content tab-no-active-fill-tab-content">
                            <div class="tab-pane fade show active" id="link1" aria-expanded="true">
                                <table id="tbl_cpa_pending_exam" class="table table-hover text-nowrap " style="width:100%;">
                                    <thead>
                                        <tr>
                            ...
                            <div class="tab-pane fade" id="link2" aria-expanded="true">
                                <table id="tbl_cpa_approved_exam" class="table table-hover text-nowrap " style="width:100%;" >
                                    <thead>
                                        <tr>
                                        <th class="bold-font-weight" >No</th>
                                            <th class="bold-font-weight" >Action</th>
                                    ...
                                    <tbody id="tbl_cpa_approved_exam_body" class="hoverTable text-left">
                                    </tbody>
                                </table>
                            </div>
                            <div class="tab-pane fade" id="link3" aria-expanded="true">
                                <table id="tbl_cpa_rejected_exam" class="table table-hover text-nowrap " style="width:100%;">
                                    <thead>
                                        <tr>
                                        <th class="bold-font-weight" >No</th>
                                            <th class="bold-font-weight" >Action</th>
