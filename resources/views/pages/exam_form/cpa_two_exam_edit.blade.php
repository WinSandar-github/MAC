                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-5 justify-content-center"> 
                                                ...
                                                <button type="submit" id="reject" name="save" class="btn btn-danger"  onclick="rejectCPATwoExam()" style="width : 20%"><i class="fa fa-thumbs-o-downn" aria-hidden="true"></i>REJECT</button>
                                            </div>
                                        </div>
