                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-5 justify-content-center"> 
                                                <button type="submit" id="approve" name="save" class="btn btn-primary" onclick="approveExam()" style="width : 20%"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>APPROVE</button>

                                                <button type="submit"  id="reject" name="save" class="btn btn-primary"  onclick="rejectExam()" style="width : 20%"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>REJECT</button>
                                            </div>
                                        </div>
