               ...
               {{-- <form action="" method="get" enctype="multipart/form-data">--}}
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-8">
                                    <h5 class="title" style="padding-left: 330px;">{{ __('CPA 1 Exam Result List') }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                            ...
                                            <div class="tab-space tab-content tab-no-active-fill-tab-content">
                                                <div class="tab-pane fade show active" id="link1" aria-expanded="true">
                                                    <table id="tbl_cpa_exam_pending_result" class="table table-hover text-nowrap ">
                                                        ...
                                                        <tbody id="tbl_cpa_exam_pending_result_body" class="hoverTable">
                                                        </tbody>
                                                    </table>
                                                </div>
                                                <div class="tab-pane fade" id="link2" aria-expanded="true">
                                                    <table id="tbl_cpa_exam_approved_result" class="table table-hover text-nowrap ">
                                                        ...
                                                        <tbody id="tbl_cpa_exam_approved_result_body" class="hoverTable">
                                                        </tbody>
                                                    </table>
                                                </div>
                                                <div class="tab-pane fade" id="link3" aria-expanded="true">
                                                    <table id="tbl_cpa_exam_rejected_result" class="table table-hover text-nowrap ">
                                                        ...
                                                        <tbody id="tbl_cpa_exam_rejected_result_body" class="hoverTable">
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
