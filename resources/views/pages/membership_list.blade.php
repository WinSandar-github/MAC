...
@section('content')
    ...
    <!-- Modal -->
    <div class="modal fade" id="create_membership_model" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" style="overflow: auto">
            <div class="modal-content">
                <form id="membership_form" method="post" action="javascript:createMembership();"
                    ...
                    <div class="modal-body">
                        <div class="row mb-1">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="text" name="membership_name" class="form-control" id="ms_name"
                                        placeholder="Membership Name Eg.School" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-1">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="number" name="form_fee" class="form-control" id="form_fee"
                                        placeholder="Form Fee" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-1">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="number" name="registration_fee" class="form-control"
                                        id="registration_fee" placeholder="Registration Fee" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-1">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="number" name="yearly_fee" class="form-control" id="yearly_fee"
                                        placeholder="Yearly Fee" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-1">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="number" name="renew_fee" class="form-control" id="yearly_fee"
                                        placeholder="Yearly Fee" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-1">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input type="number" name="late_fee" class="form-control" id="late_fee"
                                        placeholder="Delayed Fee" autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-1">
                            ...
                            <div class="col-md-9">
                                <div class="form-group">
                                    ...
                                    <textarea name="requirement" id="requirement" width="100%" height="auto"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mb-1">
                            ...
                            <div class="col-md-9">
                                <div class="form-group ">
                                    ...
                                    <textarea name="description" id="mem_desc" width="100%" height="auto"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
