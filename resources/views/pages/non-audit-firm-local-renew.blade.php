...
@extends('layouts.app', [
    'class' => '',
    'elementActive' => 'non-audit-firm-local-renew'
])
...
@section('content')
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                {{ Breadcrumbs::render('non-audit-firm-local-renew') }}
            </div>
        </div>
                                ...
                                <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text" name="firm_register_no" class="form-control" placeholder="Firm Registration No" >
                                                    </div>
                                                </div>
                                                </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        <input type="text" name="firm_name"  class="form-control  @error('name') is-invalid @enderror" placeholder="Firm Name" autofocus>
                                                    </div>
                                                </div>
                                                @error('name')
