@extends('layouts.app', [
    'class' => '',
    'parentElement' => '',
    'elementActive' => 'da_offline_student_list'
])
@section('content')
<div class="content">
                        ...
                        <div class="card">
                            ...
                            <div class="row mt-5 justify-content-center" id="approve_reject"> 
                                <button type="submit" name="save" id="reject" class="btn btn-danger"  data-toggle="modal" data-target="#exampleModal" style="width : 20%"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i>REJECT</button>
                                 ...
                                 <button type="submit" name="save" id="approve" class="btn btn-primary" onclick="approveOfflineDACPAUser()" style="width : 20%"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i>APPROVE</button>
                            </div>
                        </div>
                    </div>
                    </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" style="max-width: 600px !important">
    <div class="modal-content">
      ...
      <form id="remark-form"  method="post" action="javascript:rejectOfflineDACPAUser()" enctype="multipart/form-data">
      @csrf
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
