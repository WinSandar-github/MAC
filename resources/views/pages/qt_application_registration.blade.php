                    ...
                    <div class="card">
                        ...
                        <div class="card-body m-5">                           
                            ...
                            <div class="row">
                                ...
                                <label class="col-md-11 col-form-label">{{ __('နိုင်ငံကြားတိုင်းပြည်မှပေးအပ်သည့်ပညာအရည်အချင်း (ACCA/ CIMA ခွဲခြားဖော်ပြရန်နှင့် လက်မှတ်မိတ္တမှန် ပူးတွဲတင်ပြရန်)') }}</label><br>
                            </div>    

                            <div class="row" style="margin-right: -63px; padding-left: 47px;">
                                <label class="col-md-1 col-form-label" style="margin-right: -48px;">{{ __('(က)') }}</label>
                            ...
                            <div class="row" style="margin-right: -63px; padding-left: 47px;">
                                <label class="col-md-1 col-form-label" style="margin-right: -48px;">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label" >{{ __('ဆက်သွယ်ရန်လိပ်စာ') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                            ...
                            <div class="row" style="margin-right: -63px; padding-left: 47px;">
                                <label class="col-md-1 col-form-label" style="margin-right: -48px;">{{ __('(ခ)') }}</label>
                            ...
                            <div class="row" style="margin-right: -63px; padding-left: 47px;">
                                <label class="col-md-1 col-form-label" style="margin-right: -48px;">{{ __('(ဂ)') }}</label>
                            ...
                            <div class="row">
                                ...
                                <label class="col-md-11 col-form-label">{{ __('အထက်ဖော်ပြပါ အချက်အလက်အားလုံးမှန်ကန်ပါသည်။ မမှန်မကန်ဖော်ပြပါက စာမေးပွဲဖြေဆိုခွင့်မရှိကြောင်းနှင့် ဖြေဆိုအောင်မြင်ပါကလည်း မြန်မာနိုင်ငံစာရင်းကောင်စီ၏ အဆုံးအဖြတ်ကိုခံယူပါမည်ဟု ဝန်ခံကတိပြုပါသည်။') }}</label>                                        
                            </div></br></br>
