                    ...
                    <div class="card custom-border-top card-stats">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <input type="text" name="teacher_id_no" class="form-control"
                                               placeholder="သင်တန်းဆရာမှတ်ပုံတင်အမှတ်" required>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table education2 table-bordered input-table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center" width="10%"><input type="button"
                                                                                       ...
                                                                                       onclick='addRowEducation("education2")'
                                                                                       value="+">
                                            </td>
                                        </tr>
                                        </thead>
                                ...
                                <div class="col-md-8">
                                    <div class="row ">
                                        <div class="form-check col-md-4">
                                            <input class="form-check-input" type="radio" name="civil-servant2"
                                                   id="yes-servant">
                                    ...
                                    <table class="table subject2 table-bordered input-table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="less-font-weight text-center" width="10%"><input type="button"
                                                                                                        class="btn btn-primary btn-sm btn-plus"
                                                                                                        onclick='addRowSubject("subject2")'
                                                                                                        value="+">
                                            </td>
                                        </tr>
                                        </thead>
                                ...
                                <div class="col-md-8">
                                    <table class="table dipSubject2 table-bordered input-table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="less-font-weight text-center" width="10%"><input type="button"
                                                                                                        class="btn btn-primary btn-sm btn-plus"
                                                                                                        onclick='addRowDipSubject("dipSubject2")'
                                                                                                        value="+">
                                            </td>
                                        </tr>
                                        </thead>
                            ...
                            <div class="row">
                                ...
                                <label
                                    class="col-md-11 col-form-label">{{ __('အထက်ဖော်ပြပါ အချက်အလက်များမှန်ကန်ကြောင်းကတိပြုဝန်ခံပါသည်။') }}</label>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <label
                                    class="col-md-11 col-form-label">{{ __('သင်တန်းဆရာမှတ်ပုံတင်နှင့် ဓာတ်ပုံအပို (၂) ပုံ တင်ပြရမည်။') }}</label>
                            </div>
