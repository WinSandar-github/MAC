    ...
    <div class="col-md-12 text-center">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="text-center m-3" style="font-weight:bold">ကျောင်းသားကတ်များ၊ စာမေးပွဲဖြေဆိုခွင့်ကတ်ပြား၊ အမှတ်စာရင်းထုတ်ယူသည့်ပုံစံ၊ အောင်မြင်လက်မှတ်ကတ်ပြားများ။</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
