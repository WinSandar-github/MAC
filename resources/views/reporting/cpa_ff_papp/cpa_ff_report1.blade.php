    ...
    <div class="col-md-12 text-center">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="text-center m-3" style="font-weight:bold">ကနဦးမှတ်ပုံတင်ခွင့်ပြုသောရက်စွဲ (Initial Registration Date) အရ <br>PA လုပ်သက်အများအနည်းအလိုက် PA List စာရင်း</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
