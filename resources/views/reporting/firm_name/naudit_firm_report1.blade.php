    ...
    <div class="col-md-12 text-center">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="text-center m-3" style="font-weight:bold">Non - Audit Service လုပ်ငန်းတစ်ခု၏ Application Form ပါ အချက်အလက်များအားလုံး ပါဝင်သည့် Information အပြည့်အစုံ။</h5>
                        </div>
                    </div>
                </div>
                <div class="card-body">
